        ...
        <div className="mb-6 px-4 md:px-0">
          {!hasTableNumber && (
            <div className="bg-yellow-50 border border-yellow-200 text-yellow-900 px-5 py-4 rounded-lg">
              ...
              <p className="text-sm mt-1">Silakan pindai kode QR dari meja Anda untuk memesan.</p>
            </div>
          )}
          {hasTableNumber && !isValidTable && (
            <div className="bg-red-50 border border-red-200 text-red-900 px-5 py-4 rounded-lg">
              ...
              <p className="text-sm mt-1">Meja ini tidak ada. Silakan pindai kode QR yang valid dari meja Anda.</p>
            </div>
          )}
        </div>
